// definie actions of the Employee object, method
function printEmployee()
{
    // displayes information about Employee
    var name_line = "<td>" + this.name + "</td>";
    var title_line = "<td>" + this.title + "</td>";
    var phone_line = "<td>" + this.phone + "</td>";

    var row = "<tr>" + name_line + title_line + phone_line + "</tr>"; // table row
    document.write(row); 
}
// define an object using constructor function
function Employee(name, title, phone) // definition of objects is capitalized 
{
    // list of attributes for this object
    this.name = name;
    this.title = title;
    this.phone = phone;
    // asssign method to the employee object
...
// display the employee's information, use printEmployee method
//nick.printEmployee();
//lisa.printEmployee();
//mike.printEmployee();
